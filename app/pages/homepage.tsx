...
function Homepage() {
    return (
        <> <section className="h-screen w-screen items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]">
            ...
            <div>
            <Image className="absolute top-1/3 left-1/2 w-96 h-96 rounded-1/2 custom-transform border-9 border-sky-950 z-20"src="/mypic.jpeg" alt="MyPic" width={500} height={500} />
            </div>
        </section>
        </>
    );
